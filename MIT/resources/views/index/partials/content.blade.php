<div class="col-md-12 col-lg-12 main-content bg-light m-0 p-0" >
    <div class="scrol-down ">
        <div class="scrol-text">
            <div class="tamplate container-fluid  m-0 p-0" style="position: relative;background-color: rgb(184, 190, 197)">
                <div class="col-md-12 col-lg-12  tamplate-text d-flex align-items-center justify-content-center gap-2">
                    <img src="{{ asset('images/_thumbnail-mit-dome_0.jpeg') }}" alt="" width="100px">
                    <a href="">Updates from campus:</a>
            ...
            <div class="scrol-down-text">
                <div class="scrol-img">
                    <img src="{{ asset('images/MIT-Overturned-Ocean-SL.jpg') }}" alt="" width="100%">
                </div>
                <div>
            ...
            <div class="scrol-img container mt-5">
                ...
                <div class="row mt-5">
                    <div class="col-md-12 col-lg-6">
                        <img src="{{ asset('images/MIT-Zhang-SL.jpg') }}" alt="" width="100%">
                    ...
                    <div class="col-md-12 col-lg-6">
                        <img src="{{ asset('images/MIT-Cady-Coleman-SL.jpg') }}" alt="" width="100%">
                        <div class="img-text mt-4">
                            <h4>COMMUNITY SPOTLIGHT</h4>
                ...
                <div class="row mt-5">
                    <div class="col-md-12 col-lg-6">
                        <img src="{{ asset('images/iStock-1313232216-home.jpg') }}" alt="" width="100%">
                        <div class="img-text mt-4">
                            <h4>RESEARCH</h4>
                    ...
                    <div class="col-md-12 col-lg-6">
                        <img src="{{ asset('images/MIT-Stronger-Titanium-home.jpg') }}" alt="" width="100%">
                        <div class="img-text mt-4">
                            <h4>RESEARCH</h4>
                ...
                <div class="row mt-5">
                    <div class="col-md-12 col-lg-6">
                        <img src="{{ asset('images/HERR-Nature-Medicine-Image-01-home.jpg') }}" alt=""
                            width="100%">
                        <div class="img-text mt-4">
                            <h4>INNOVATION</h4>
                    ...
                    <div class="col-md-12 col-lg-6">
                        <img src="{{ asset('images/MIT-Centner-home.jpg') }}" alt="" width="100%">
                        <div class="img-text mt-4">
                            <h4>COMMUNITY SPOTLIGHT</h4>
